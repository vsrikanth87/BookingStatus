...
namespace BSS.Models
{
    ...
    public class SearchParameterModel
    {
        ...
        [Display(Name = "Search By BookingArrivedEnquiredDateTime")]
        public string BookingArrivedEnquiredDateTime
        {
            get;
        ...
        [Display(Name = "Search By BookingArrivedEnquiredDateTime")]
        public string BookingArrivedEnquiredDateTime1
        {
            get;
    ...
    public class BookingArrived
    {
       // [Key]
        ...
        public string QuotationSendDateTime
        {
        ...
        public BookingArrived() { }

        public BookingArrived(int bookingarrivedId, string bookingarrivedenquireddatetime, string bookingarrivedenquiredtime, string bookingarrivedenquireddetails,
            string traveldate, int agentId, int consultantId, string quotationsenddatetime, string quotationsendtime, string tourplanrefrence,
